...
use std::any::{Any,TypeId};
		...
		pub const LPAR:isize=11; 
		pub const RPAR:isize=12; 
		pub const COMMA:isize=13; 
		pub const DOUBLEQUOTE:isize=14; 
		pub const QUOTE:isize=15; 
		pub const SLASH:isize=16; 
		pub const BACKSLASH:isize=17; 
		pub const LBRACKET:isize=18; 
		pub const RBRACKET:isize=19; 
		pub const DOT:isize=20; 
		pub const DOUBLEDOT:isize=21; 
		pub const SEMICOLON:isize=22; 
		pub const KLEENE:isize=23; 
		pub const WILDCARD:isize=24; 
		pub const EQUAL:isize=25; 
		pub const ID:isize=26; 
		pub const NUMBER:isize=27; 
		pub const STRING:isize=28; 
		pub const CHARACTER:isize=29; 
		pub const LINECOMMENT:isize=30; 
		pub const COMMENT:isize=31; 
		pub const NEWLINE:isize=32; 
		pub const WS:isize=33;
	...
	pub const RULE_assignation:usize = 9; 
	pub const RULE_attribut:usize = 10; 
	pub const RULE_tuple:usize = 11; 
	pub const RULE_tuple_content:usize = 12; 
	pub const RULE_tuple_space_name:usize = 13; 
	pub const RULE_init_var:usize = 14; 
	pub const RULE_protocol:usize = 15; 
	pub const RULE_ip_address:usize = 16; 
	pub const RULE_port:usize = 17;
	pub const ruleNames: [&'static str; 18] =  [
		"root", "instruction", "connect", "create", "delete", "attach", "read", 
		"in_instr", "out", "assignation", "attribut", "tuple", "tuple_content", 
	...
	pub const _LITERAL_NAMES: [Option<&'static str>;26] = [
		...
		Some("'var'"), Some("'('"), Some("')'"), Some("','"), Some("'\"'"), Some("'''"), 
		Some("'/'"), Some("'\\'"), Some("'['"), Some("']'"), Some("'.'"), Some("':'"), 
		Some("';'"), Some("'*'"), Some("'_'"), Some("'='")
	];
	pub const _SYMBOLIC_NAMES: [Option<&'static str>;34]  = [
		None, Some("CONNECT"), Some("ATTACH"), Some("CREATE"), Some("DELETE"), 
		Some("OUT"), Some("READ"), Some("IN"), Some("TCP"), Some("UDP"), Some("VAR"), 
		Some("LPAR"), Some("RPAR"), Some("COMMA"), Some("DOUBLEQUOTE"), Some("QUOTE"), 
		Some("SLASH"), Some("BACKSLASH"), Some("LBRACKET"), Some("RBRACKET"), 
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<RootContextAll<'input>>,ANTLRError> {
		...
		let result: Result<(), ANTLRError> = try {
			...
			while (((_la) & !0x3f) == 0 && ((1usize << _la) & ((1usize << CONNECT) | (1usize << ATTACH) | (1usize << CREATE) | (1usize << DELETE) | (1usize << OUT) | (1usize << READ) | (1usize << IN) | (1usize << VAR))) != 0) {
				{
				{
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<AssignationContextAll<'input>>,ANTLRError> {
        ...
        recog.base.enter_rule(_localctx.clone(), 18, RULE_assignation);
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<AttributContextAll<'input>>,ANTLRError> {
        ...
        recog.base.enter_rule(_localctx.clone(), 20, RULE_attribut);
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<TupleContextAll<'input>>,ANTLRError> {
        ...
        recog.base.enter_rule(_localctx.clone(), 22, RULE_tuple);
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<Tuple_contentContextAll<'input>>,ANTLRError> {
        ...
        recog.base.enter_rule(_localctx.clone(), 24, RULE_tuple_content);
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<Tuple_space_nameContextAll<'input>>,ANTLRError> {
        ...
        recog.base.enter_rule(_localctx.clone(), 26, RULE_tuple_space_name);
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<Init_varContextAll<'input>>,ANTLRError> {
        ...
        recog.base.enter_rule(_localctx.clone(), 28, RULE_init_var);
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<ProtocolContextAll<'input>>,ANTLRError> {
        ...
        recog.base.enter_rule(_localctx.clone(), 30, RULE_protocol);
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<Ip_addressContextAll<'input>>,ANTLRError> {
        ...
        recog.base.enter_rule(_localctx.clone(), 32, RULE_ip_address);
    ...
    H: ErrorStrategy<'input,BaseParserType<'input,I>>
{
	...
	-> Result<Rc<PortContextAll<'input>>,ANTLRError> {
        ...
        recog.base.enter_rule(_localctx.clone(), 34, RULE_port);
...
const _serializedATN:&'static str =
	...
	\x23\u{a0}\x04\x02\x09\x02\x04\x03\x09\x03\x04\x04\x09\x04\x04\x05\x09\x05\
	...
	\x09\x13\x03\x02\x07\x02\x28\x0a\x02\x0c\x02\x0e\x02\x2b\x0b\x02\x03\x03\
	\x03\x03\x03\x03\x03\x03\x03\x03\x03\x03\x03\x03\x03\x03\x05\x03\x35\x0a\
	...
	\x0a\x07\x0a\x69\x0a\x0a\x0c\x0a\x0e\x0a\x6c\x0b\x0a\x03\x0b\x03\x0b\x03\
	\x0b\x03\x0b\x03\x0b\x03\x0c\x03\x0c\x03\x0d\x03\x0d\x03\x0d\x03\x0d\x07\
	\x0d\x79\x0a\x0d\x0c\x0d\x0e\x0d\x7c\x0b\x0d\x03\x0d\x03\x0d\x03\x0d\x05\
	\x0d\u{81}\x0a\x0d\x03\x0e\x03\x0e\x03\x0e\x03\x0e\x03\x0e\x03\x0e\x05\x0e\
	\u{89}\x0a\x0e\x03\x0f\x03\x0f\x03\x10\x03\x10\x03\x10\x03\x10\x03\x10\x05\
	\x10\u{92}\x0a\x10\x03\x11\x03\x11\x03\x12\x03\x12\x03\x12\x03\x12\x03\x12\
	\x03\x12\x03\x12\x03\x12\x03\x13\x03\x13\x03\x13\x02\x02\x14\x02\x04\x06\
	\x08\x0a\x0c\x0e\x10\x12\x14\x16\x18\x1a\x1c\x1e\x20\x22\x24\